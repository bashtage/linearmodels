...
ivregress 2sls rent pcturban (hsngval = faminc i.region), vce(cluster division)
estout using c:\git\panel\panel\iv\tests\results\stata-iv2sls-cluster.txt, cells(b(fmt(%13.12g)) t(fmt(%13.12g))) stats(r2 r2_a chi2 p mss rss, fmt(%13.12g)) unstack replace
matrix V = e(V)
file open myfile using "c:\git\panel\panel\iv\tests\results\stata-iv2sls-cluster.txt", write append
file write myfile  "************************************\n"
file close myfile
estout matrix(V, fmt(%13.12g)) using c:\git\panel\panel\iv\tests\results\stata-iv2sls-cluster.txt, append
...
ivregress gmm rent pcturban (hsngval = faminc i.region), wmatrix(cluster division)
estout using c:\git\panel\panel\iv\tests\results\stata-ivgmm-cluster.txt, cells(b(fmt(%13.12g)) t(fmt(%13.12g))) stats(r2 r2_a chi2 p mss rss, fmt(%13.12g)) unstack replace
matrix V = e(V)
file open myfile using "c:\git\panel\panel\iv\tests\results\stata-ivgmm-cluster.txt", write append
file write myfile  "************************************\n"
file close myfile
estout matrix(V, fmt(%13.12g)) using c:\git\panel\panel\iv\tests\results\stata-ivgmm-cluster.txt, append
