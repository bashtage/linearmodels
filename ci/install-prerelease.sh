...
pip install -i https://pypi.anaconda.org/scipy-wheels-nightly/simple numpy scipy pandas --upgrade
pip install ${PIP_FLAGS} matplotlib matplotlib seaborn cython statsmodels --upgrade
